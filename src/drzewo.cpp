...
void drzewo::rysuj_protopadloscian(mat4 V, mat4 M, float a, float b, float c){
    mat4 Mk = M;
...
void drzewo::rysuj_galaz(mat4 M_Matki,float wys_matki, mat4 V, float wzrost, galaz G)
   ...
   rysuj_protopadloscian(V, M,  0.4f, G.dlugosc_galezi , 0.4f);
...
void drzewo::rysuj_drzewo(mat4 Mz, mat4 V, float wzrost)
    ...
    rysuj_protopadloscian(V, M, float(grubosc_drzewa), wzrost*float(wysokosc_drzewa), float(grubosc_drzewa));
